    ...
    return(
        <div>
            <ul className = "mt-[140px]">
                ...
                <li className = {`w-[50%] text-xl ${currentSection === "projects" ? selectedStyles : unSelectedStyles} ${hoverStyles}`}><a className="flex items-center" href="#projects"><IoRemoveOutline /> PROJECTS</a></li>
            </ul>
        </div>
    );
}